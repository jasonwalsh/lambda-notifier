...
This is a sample template for notifier - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name notifier --tail
```
...
```bash
aws cloudformation delete-stack --stack-name notifier
```
